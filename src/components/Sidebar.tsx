...
export const Sidebar: React.FC<SidebarProps> = ({
    ...
    return (
        <div
            className={`absolute top-0 left-0 h-full w-[360px] z-30 transition-transform duration-300 ease-in-out pointer-events-none ${isCollapsed ? '-translate-x-full' : 'translate-x-0'
                }`}
        >
            <div className="w-full h-full flex flex-col bg-zinc-900/96 border-r border-white/10 shadow-2xl overflow-hidden pointer-events-auto">
                ...
                <div className="px-5 pb-2 flex-shrink-0">
                    <span className="text-[20px] font-light tracking-[-0.5px] text-white/80 tabular-nums leading-tight block mb-2">
                            ...
                            <div className="flex items-center gap-2 flex-shrink-0 ml-2">
                                {selectedCountries.size > 0 && (
                                    <span
                                        ...
                                        className="text-white/30 hover:text-white/70 transition-colors text-[10px] leading-none"
                                        title="Clear"
                                    >
                                        ✕
                                    </span>
                        ...
                        {isCountryOpen && (
                            <div className="flex flex-col bg-zinc-900 border border-white/10 rounded-md overflow-hidden shadow-xl">
                                <div className="flex items-center gap-2 px-3 py-2 border-b border-white/5">
                                    ...
                                    />
                                    {countrySearch && (
                                        <button onClick={() => setCountrySearch('')} className="text-white/25 hover:text-white/60 transition-colors text-[10px] flex-shrink-0">✕</button>
                                    )}
                                </div>
