                            ...
                            <div className="flex items-center gap-2 flex-shrink-0 ml-2">
                                {selectedCountries.size > 0 && (
                                    <span
                                        ...
                                        className="text-white/30 hover:text-white/70 transition-colors text-[11px] leading-none"
                                    >
                                        ✕
                                    </span>
                                )}
                        ...
                        {isCountryOpen && (
                            <div className="flex flex-col bg-zinc-900 border border-white/10 rounded-md overflow-hidden shadow-xl">
                                <div className="flex items-center gap-2 px-3 py-2.5 border-b border-white/5">
                                    ...
                                    />
                                    {countrySearch && (
                                        <button onClick={() => setCountrySearch('')} className="text-white/25 hover:text-white/60 transition-colors text-[11px] flex-shrink-0">✕</button>
                                    )}
                                </div>
